...
export const coursesList: Course[] = [
  ...
  // Advance-Digital-Marketing-with-AI-Tools
  {
    ...
    tools: [
      ...
      { type: "Google Gemini", img: gemini },
      { type: "Perplexity", img: perplexity },
    ],
    content: [
      ...
      "Creating Responsive websites with Coding",
  ...
  // Graphic-Designing-&-Animation
  {
    ...
    tools: [
      ...
      { type: "Adobe Lightroom", img: lightroom },
      { type: "Adobe Animate", img: animate },
      { type: "Canva", img: canva },
      { type: "Adobe After Effects", img: aftereffect },
      { type: "Adobe Premiere Pro", img: Premierepro },
      { type: "Blender", img: blender },
      { type: "3ds Max", img: max },
    ],
    content: [
      "Adobe Photoshop",
      "Adobe Illustrator",
